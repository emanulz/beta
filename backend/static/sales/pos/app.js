...
var _browserEvents = require('./lib/browserEvents');

var _loadToLocalStorage = require('./lib/loadToLocalStorage');
...
function mainSales(store) {
    ...
    //EVENTS
    (0, _browserEvents.browserObjectEvents)(store);

    //LOAD TO LOCAL STORAGE
    (0, _loadToLocalStorage.loadToLocalStorage)(store);
} //MAIN FUNCTION
//------------------------------------------------------------------------------------------

},{"./lib/browserEvents":6,"./lib/loadToLocalStorage":8,"alertifyjs":1,"jquery":2,"mouseTrap":3,"priceFormat":12}],5:[function(require,module,exports){
'use strict';
...
function blurElement(element, size) {
  ...
  $(element).css('filter', filterVal).css('webkitFilter', filterVal).css('mozFilter', filterVal).css('oFilter', filterVal).css('msFilter', filterVal);
}
//------------------------------------------------------------------------------------------
...
exports.browserObjectEvents = browserObjectEvents;

var _blurElement = require("./blurElement");

var _handleCode = require("./handleCode");

var _updateTotals = require("./updateTotals");

var _rowUpdate = require("./rowUpdate");

var _setClient = require("./setClient");
...
//------------------------------------------------------------------------------------------
function browserObjectEvents(store) {
    //--------------------------------------------------------------------------------------
    ...
    product_code_field.on('keypress', function (e) {
        if (e.which === 13) {
            store = (0, _handleCode.handleCode)(product_code_field.val(), store);
        }
    });
    ...
    html.on('change', '.client_code_field', function () {
        ...
        (0, _setClient.setClient)(client_code_field.val());
    });
    ...
    html.on('change', '.product_qty', function () {
        ...
        store = (0, _rowUpdate.rowUpdate)(rowIndex, code, qty, saleList, 2, disc, store);

        store = (0, _updateTotals.updateTotals)(store);
    });
    ...
    html.on('change', '.product_disc', function () {
        ...
        (0, _rowUpdate.rowUpdate)(rowIndex, code, qty, saleList, 4, disc);

        (0, _updateTotals.updateTotals)();
    });
    ...
    $(document).on('keydown', function (e) {
        ...
        if (e.which == 107) {
            ...
            if (rowIndex != -1) {
                ...
                store = (0, _rowUpdate.rowUpdate)(rowIndex, code, 1, saleList, 1, 0, store);
    ...
    $(':input').focusin(function () {
        ///ON ANY INPUT FOCUS DESELECT ALL ROWS
        $('.table-product-selected').removeClass('table-product-selected');
    });
...
},{"./blurElement":5,"./handleCode":7,"./rowUpdate":9,"./setClient":10,"./updateTotals":11,"jquery":2}],7:[function(require,module,exports){
'use strict';
...
//------------------------------------------------------------------------------------------
function handleCode(codeStr, store) {
    ...
    if (isOnArray === -1) {
        ...
        if (products.length) {
            ...
            store.saleList = (0, _rowUpdate.rowUpdate)(isOnArray, code, qty, store.saleList, 1, 0);
            store = (0, _updateTotals.updateTotals)(store);
        } //else
...
function isCodeOnArray(array, code) {
    ...
    $.each(array, function (i) {
        ...
        if (array[i][0] == code || array[i][1] == code) {
            // Eval Code and Barcode
            control = i;
            return false;
        }
    });
...
function prepareNewRow(products, qty, store) {
    ...
    store = addNewRow(products[0].code, products[0].barcode, products[0].description, qty, products[0].price, subt, products[0].id, products[0].discount, iv, store);
...
},{"./rowUpdate":9,"./updateTotals":11,"alertifyjs":1,"jquery":2}],8:[function(require,module,exports){
"use strict";
...
//------------------------------------------------------------------------------------------
function loadToLocalStorage(store) {
...
function productsToMemory(store) {
    ...
    $.get("/api/products/?company=" + store.companyId, function (data) {}).success(function (data) {
...
function clientsToMemory(store) {
    ...
    $.get("/api/clients/?company=" + store.companyId, function (data) {}).success(function (data) {
